...
import { customersData } from "@/lib/app-data";
import { AdminCustomersFullColumns } from "@/lib/tableData/AdminColumns";
...
const Customer = () => {
	...
	const customers = useMemo<User[]>(() => customersData, []);
	const columns = useMemo<ColumnDef<User>[]>(
		() => AdminCustomersFullColumns,
		[]
	);
